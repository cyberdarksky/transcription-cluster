...
class CoordinatorClient:
    ...
    async def register(
        ...
        return RegisterResponse(
            ...
            whisper_model=settings.get("whisper_model", "/opt/transcription-models/whisper-medium-mlx"),
    ...
    async def claim_next_job(self, worker_id: uuid.UUID) -> JobAssignment | None:
        ...
        return JobAssignment(
            ...
            whisper_model=ws.get("model", "/opt/transcription-models/whisper-medium-mlx"),
